...
function cellClass(minutes: number): string {
  ...
  if (minutes < 30) return 'bg-rose-900/70'
  if (minutes < 60) return 'bg-rose-700/70'
  if (minutes < 120) return 'bg-rose-500/70'
  ...
  return (
    <div className="overflow-x-auto">
      <div className="inline-flex gap-[3px]">
        <div className="mr-1 flex flex-col justify-between py-0.5 text-[10px] text-zinc-500">
          {WEEKDAY_SHORT.map((d) => (
